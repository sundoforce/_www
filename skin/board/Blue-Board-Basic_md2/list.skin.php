	...
	<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
		...
		<div id="bo_btn_top" class="f-small clearfix">
			<ul class="btn_bo_user pull-right">
				<?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_custom_admin btn" title="설정" role="button"><span class="">설정</span></a></li><?php } ?>
				<?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fa fa-rss" aria-hidden="true"></i><span class="sound_only">RSS</span></a></li><?php } ?>
				<li>
					<button type="button" class="btn_custom_01 btn" title="게시판 검색" data-toggle="collapse" data-target="#bo_search" aria-expanded="false" aria-controls="bo_search"><span class="">검색</span></button>
				</li>
				<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_custom_02 btn" title="글쓰기"><span class="">글쓰기</span></a></li><?php } ?>
