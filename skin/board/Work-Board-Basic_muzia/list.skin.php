...
<div id="bo_list">
	...
	<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form form-custom">
		<input type="hidden" name="bo_table" value="<?php echo $bo_table ?>">
		...
		<div id="bo_btn_top" class="f-small clearfix">
			<ul class="btn_bo_user pull-right">
				<?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_img_01 btn" title="관리자" role="button"><img class="board_icon" src="<?php echo $board_skin_url ?>/img/gear-icon.png">관리자<span class="sound_only">관리자</span></a></li><?php } ?>
				<?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_img_02 btn" title="RSS"><img class="board_icon" src="<?php echo $board_skin_url ?>/img/rss-icon.png">RSS<span class="sound_only">RSS</span></a></li><?php } ?>
				<li>
					<button type="button" class="btn_img_03 btn" title="게시판 검색" data-toggle="collapse" data-target="#bo_search" aria-expanded="false" aria-controls="bo_search"><img class="board_icon_search" src="<?php echo $board_skin_url ?>/img/search-icon.png">검색<span class="sound_only">게시판 검색</span></button>
				</li>
				<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_img_04 btn" title="글쓰기" role="button"><img class="board_icon" src="<?php echo $board_skin_url ?>/img/pencil-icon.png">글쓰기<span class="sound_only">글쓰기</span></a></li><?php } ?>
