			...
			<div class="sidebar-icon-tbl">
				...
				<div class="sidebar-icon-cell">
					<a href="<?php echo G5_ATTENDANCE_URL;?>/attendance.php">
                        <i class='fa fa-paw circle normal bg-skyblue'></i>
<!--						<i class="fa fa-paw circle light-circle bg-skyblue" aria-hidden="true"></i>-->
						<span>출석</span>
					</a>
				</div>
				<div class="sidebar-icon-cell">
				...
				<?php if(isset($me['sub'])) { //Is Sub Menu ?>
					...
					?>
						...
						<li class="me-li1<?php echo ($me1['on']) ? ' active' : ''; ?>">
							...
							<a class="me-a1" href="<?php echo $me1['me_link'];?>" target="<?php echo $me1['target'];?>">
								<?php echo $me1['me_name'];?>
							</a>
							<?php if(isset($me1['sub'])) { // Is Sub Menu ?>
								<ul class="me-ul2 tree <?php echo ($me1['on']) ? 'on' : 'off'; ?>">
								<?php 
									for($k=0; $k < count($me1['sub']); $k++) {
										$me2 = $me1['sub'][$k];
								?>
									...
									<li class="me-li2<?php echo ($me2['on']) ? ' active' : ''; ?>">
										<a class="me-a2" href="<?php echo $me2['me_link'] ?>" target="<?php echo $me2['target'] ?>">
