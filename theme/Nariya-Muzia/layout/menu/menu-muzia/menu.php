				...
				<div class="me-cell me-list">
					<ul class="me-ul nav-slide">
					 <?php
                        ...
                        $i = 0;
                        foreach( $menu_datas as $me ){
                            if( empty($me) ) continue;
                        ?>
						<li class="me-li<?php echo ($me['on']) ? ' on' : ''; ?>">
							<a class="me-a" href="<?php echo $me['me_link'];?>" target="<?php echo $me['target'];?>">
								<i class="<?php echo $me['icon'] ?>" aria-hidden="true"></i>
								<?php echo $me['me_name'];?>
							</a>
							<?php if(isset($me['sub'])) { //Is Sub Menu ?>
								<div class="sub-slide sub-1div">
									<ul class="sub-1dul">
									<?php for($j=0; $j < count($me['sub']); $j++) {
											$me1 = $me['sub'][$j];
									?>
										...
										<li class="sub-1dli<?php echo ($me1['on']) ? ' on' : ''; ?>">
											<a href="<?php echo $me1['me_link'];?>" class="me-sh sub-1da<?php echo (isset($me1['sub'])) ? ' sub-icon' : '';?>" target="<?php echo $me1['target'];?>">
												<?php echo $me1['me_name'];?>
											</a>
											<?php if(isset($me1['sub'])) { // Is Sub Menu ?>
