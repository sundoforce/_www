...
add_stylesheet('<link rel="stylesheet" href="'.$nt_menu_url.'/amt/css/amt-meg1.css">', 0);
...
<div id="nt_menu_wrap">
	...
	<!-- Mobile Header -->
	<header id="header_mo" class="bg-<?php echo $tset['logo_color'] ?> amt-meg1">
	...
	<!-- Mobile Search -->
	<div id="search_mo" class="collapse amt-meg1">
				...
				<div class="me-cell me-list">
					<ul class="me-ul nav-slide">
					 <?php
                        ...
                        ?>
                        <li class="me-li" style="z-index:<?php echo $gnb_zindex--; ?>">
                            <?php
                            $k = 0;
                            foreach( (array) $row['sub'] as $row2 ){
                                ...
                                if($k == 0)
                                    echo '<span class="bg">하위분류</span><ul class="sub-2dli">'.PHP_EOL;
                            ?>
                                <li class="sub-slide sub-1div"><a href="<?php echo $row2['me_link']; ?>" target="_<?php echo $row2['me_target']; ?>" class="gnb_2da"><?php echo $row2['me_name'] ?></a></li>
                            <?php
                            $k++;
                            }   //end foreach $row2
				    	...
				    	<?php foreach( $menu_datas as $row ){ if( empty($row) ) continue; ?>
                            <li class="me-li<?php echo ($row['on']) ? ' on' : ''; ?>">
						         <a href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>" class="me-a"><?php echo $row['me_name'] ?></a>
								<?php echo $me['text'];?>
							</a>
							 <?php
                                $k = 0;
                                ...
                                ?>
                                    <li class="sub-2dli<?php echo ($row2['on']) ? ' on' : ''; ?>"><a href="<?php echo $row2['me_link']; ?>" target="_<?php echo $row2['me_target']; ?>" class="gnb_2da"><?php echo $row2['me_name'] ?></a></li>
                                <?php
                                $k++;
                                }   //end foreach $row2
	...
	<!-- 전체 메뉴 -->
	<nav id="nt_menu_all" class="me-all amt-meg1">
