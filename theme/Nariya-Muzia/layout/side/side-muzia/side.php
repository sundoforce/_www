...
<?php if($is_index) { // 인덱스에서만 출력 ?>
	<!-- 로그인 시작 -->
	<h3 class="h3 en">
	    <a href="https://muzia.net/bbs/login.php">
...
<?php } else { // 페이지에서는 메뉴 출력 ?>
    <?php echo na_widget('insoft-outlogin'); // 외부로그인 위젯 ?>
	<?php
			//$side_category = na_widget('miso-category');

	$mes = get_menu_db(0, true);
...
<hr class="hr line-<?php echo NT_COLOR ?>"/>
<?php echo na_widget('basic-wr-list', 'best', 'bo_list=video ca_list=게임'); ?>
<div class="h20"></div>
<!-- 위젯 끝-->
